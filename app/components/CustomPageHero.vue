...
const headlineClasses = computed(() => {
  const classes = ['mb-8', 'font-medium', 'text-[#1C1C1C]', 'flex', 'items-center', 'gap-1.5', 'font-sans', 'text-sm', 'sm:text-base']
...
<template>
  <div class="relative isolate">
    <div :class="['flex flex-col max-w-7xl mx-auto lg:grid py-24 sm:py-32 lg:py-40 gap-16 sm:gap-y-24', orientationClasses]">
